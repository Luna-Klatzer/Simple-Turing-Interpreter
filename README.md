...
- [ ] Implement an interpreter able to lex, parse and then execute the instructions from the start while storing the infinite tape in memory using 8-bit typed arrays (preferably using C++)
- [ ] Implement reflection API returning callbacks that allow each operation to be caught and visualised on a front-end (using emcripten WASM compilation & binding)
...
Copyright © Luna Klatzer, 2026, licensed under the EUPL.
